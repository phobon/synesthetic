...
export const VerticalLerpMaterial = React.forwardRef(({ offsetFactor, pages, viewportHeight, top, ...props }: any, ref) => {
  ...
  return (
    <verticalLerpMaterialImpl ref={mergeRefs([ref, materialRef])} attach="material" {...props} />
  );
});